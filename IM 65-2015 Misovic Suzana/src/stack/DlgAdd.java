...
//https://stackoverflow.com/questions/7823477/warning-serial-serializable-class-someclass-has-no-definition-of-serialversio/7823531#7823531
...
public class DlgAdd extends JDialog {
	...
	public void setUneseno(boolean isAdded) {
				...
				btnAdd.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						if (getTxtX().getText().isEmpty() || getTxtY().getText().isEmpty()
								|| getTxtSirina().getText().isEmpty() || getTxtVisina().getText().isEmpty()) {
							isOK = false;
							setVisible(true);
